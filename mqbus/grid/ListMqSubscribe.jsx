...
import NewMqSubscribe from '../form/NewMqSubscribe';
...
const LIST_URL=URI.MQBUS.CORE_DATASOURCE_MONITOR.list;
const DELETE_URL=URI.MQBUS.CORE_DATASOURCE_MONITOR.delete;
const exporConfigUrl=URI.MQBUS.CORE_DATASOURCE_MONITOR.exportConfig;
const START_URL=URI.MQBUS.CORE_DATASOURCE_MONITOR.start;
const CLOSE_URL=URI.MQBUS.CORE_DATASOURCE_MONITOR.close;

class ListMqSubscribe extends React.Component {
  constructor(props) {
    super(props);
  ...
  addTabPane=(id,name,record)=>{
      ...
      let content;
      if(id==='New'){
        content=(<NewMqSubscribe id="" appId={this.props.appId}  close={this.closeCurrentTab} />);
      }else if(id==='Edit'){
        content=(<NewMqSubscribe id={record.id} appId={this.props.appId}  close={this.closeCurrentTab} />);
      }
  ...
  render(){
    ...
    const expandedRow=(record)=>{
      return (
        <ListMqRecevieMessage parentId={record.id} />
        );
    }
...
export default ListMqSubscribe;

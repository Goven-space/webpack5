...
import NewMqTopic from '../form/NewMqTopic';
...
const LIST_URL=URI.MQBUS.MQ_TOPIC_MGR.list;
const DELETE_URL=URI.MQBUS.MQ_TOPIC_MGR.delete;
const exporConfigUrl=URI.MQBUS.MQ_TOPIC_MGR.exportConfig;

class ListTopicManager extends React.Component {
  constructor(props) {
    super(props);
  ...
  addTabPane=(id,name,record)=>{
      ...
      let content;
      if(id==='New'){
        content=(<NewMqTopic id="" appId={this.props.appId}  close={this.closeCurrentTab} />);
      }else if(id==='Edit'){
        content=(<NewMqTopic id={record.id} appId={this.props.appId}  close={this.closeCurrentTab} />);
      }
    ...
    return (
      <span>
            <Tabs
              ...
              hideAdd={true}
            >
            <TabPane tab="所有主题列表" key="home" style={{padding:'0px'}}>
              <Row style={{marginBottom:5}} gutter={0} >
                <Col span={12} >
                <ButtonGroup>
                  <Button  type="primary" onClick={this.onActionClick.bind(this,'New')} icon="plus"  >新增主题</Button>

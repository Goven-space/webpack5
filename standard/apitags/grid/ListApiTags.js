...
import NewApiTags from '../form/NewApiTags';

//api标签列表

const Search = Input.Search;
const confirm = Modal.confirm;
const LIST_URL=URI.CORE_ApiTagsConfig.listManager;
const DELETE_URL=URI.CORE_ApiTagsConfig.delete;
const EXPORT=URI.CORE_ApiTagsConfig.export;

class ListApiTags extends React.Component {
  constructor(props) {
    super(props);
    this.state={
  ...
  render(){
    ...
    return (
      <div>
          <Modal key={Math.random()} title="标签属性" maskClosable={false}
            ...
            <NewApiTags  id={currentId} close={this.closeModal} />
          </Modal>
        <Row style={{marginBottom:5}} gutter={0} >
          <Col span={12} >
            <Button  type="primary" onClick={this.onActionClick.bind(this,'New')} icon="plus" >新增标签</Button>{' '}

...
import NewMasterData from '../form/NewMasterData';
import EditJsonFields from './EditJsonFields';

//Header码列表

const Search = Input.Search;
const confirm = Modal.confirm;
const LIST_URL=URI.CORE_MasterData.listManager;
const DELETE_URL=URI.CORE_MasterData.delete;
const EXPORT=URI.CORE_MasterData.export;
...
class ListMasterData extends React.Component {
  ...
  render(){
    ...
    return (
      <div>
          <Modal key={Math.random()} title="主数据属性" maskClosable={false}
            ...
            <NewMasterData  id={currentId} close={this.closeModal} />
          </Modal>
        <Row style={{marginBottom:5}} gutter={0} >
          <Col span={12} >
            <Button  type="primary" onClick={this.onActionClick.bind(this,'New')} icon="plus" >新增模型</Button>{' '}

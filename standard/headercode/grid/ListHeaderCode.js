...
import NewErrorCode from '../form/NewHeaderCode';

//Header码列表

const Search = Input.Search;
const confirm = Modal.confirm;
const LIST_URL=URI.CORE_HeaderCodes.listManager;
const DELETE_URL=URI.CORE_HeaderCodes.delete;
const EXPORT=URI.CORE_HeaderCodes.export;
...
class ListHeaderCode extends React.Component {
  ...
  render(){
    ...
    return (
      <div>
          <Modal key={Math.random()} title="Header头属性" maskClosable={false}
        ...
        <Row style={{marginBottom:5}} gutter={0} >
          <Col span={12} >
            <Button  type="primary" onClick={this.onActionClick.bind(this,'New')} icon="plus" >新增Header头</Button>{' '}

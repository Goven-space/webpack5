        ...
        <Tabs size="large">
          <TabPane  tab="预警规则基本属性" key="props"  >
            ...
            <FormItem
              ...
              labelCol={{ span: 4 }}
              wrapperCol={{ span: 16 }}
              help='指定要进行预警监控的错误码多个用逗号分隔如：404,500,403，4XX表示所有4开头的错误码,不支持200状态码'
            >{
              getFieldDecorator('condition',{rules: [{ required: true}],initialValue:"404,500"})
              (<Input  />)
              }
            </FormItem>
            <FormItem
            ...
            <FormItem
              ...
              labelCol={{ span: 4 }}
              wrapperCol={{ span: 16 }}
              help='指定在总请求次数中错误码累计达到多少次后发送预警消息'
            >{
              getFieldDecorator('thresholdCount',{rules: [{ required: true}],initialValue:1})
              (<InputNumber min={1} />)
              }
            </FormItem>
            <FormItem
...
const NewResponseCodeRule = Form.create()(form);

export default NewResponseCodeRule;

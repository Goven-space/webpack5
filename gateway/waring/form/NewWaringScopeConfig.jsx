...
import SelectAPI from '../../security/form/SelectAPI';
...
const submitUrl=URI.CORE_GATEWAY_WARING.scopesave;
...
class form extends React.Component{
  ...
  saveSelectedServices=(item)=>{
      ...
      if(selectedRows.length>1){AjaxUtils.showError("每次只能选择一个API接口");return;}
    ...
    <Spin spinning={this.state.mask} tip="Loading..." >
      ...
      <Form>
        ...
        <FormItem
          ...
          wrapperCol={{ span: 16 }}
        >
        <Button onClick={this.showModal} >选择API</Button>
        </FormItem>

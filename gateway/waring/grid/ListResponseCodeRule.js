...
import NewResponseCodeRule from '../form/NewResponseCodeRule';
...
class ListResponseCodeRule extends React.Component {
  constructor(props) {
    super(props);
    ...
    return (
      <div >
          <Modal key={Math.random()}  maskClosable={false}
            ...
            <NewResponseCodeRule  id={currentId}  close={this.closeModal} />
          </Modal>
...
export default ListResponseCodeRule;

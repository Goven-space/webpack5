...
import NewRequestSpeedRule from '../form/NewRequestSpeedRule';
...
class ListRequestSpeedRule extends React.Component {
  ...
  render(){
    ...
    const columns=[{
        ...
        render: (text,record) =>{
          if(text==='ip'){
            return <Tag>IP {record.totalRequestCount+'/'+record.thresholdCount}次</Tag>;
          }else if(text==='userId'){
            return <Tag>用户 {record.totalRequestCount+'/'+record.thresholdCount}次</Tag>;
          }else if(text==='requestUrl'){
            return <Tag>URL {record.totalRequestCount+'/'+record.thresholdCount}次</Tag>;
          }else if(text==='second'){
            return <Tag>{record.thresholdCount}/tps</Tag>;
          }
        }
      },{
        title: '间隔(秒)',
    ...
    return (
      <div >
          <Modal key={Math.random()}  maskClosable={false}
            ...
            <NewRequestSpeedRule  id={currentId}  close={this.closeModal} />
          </Modal>

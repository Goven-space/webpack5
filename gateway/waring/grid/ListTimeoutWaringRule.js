...
import NewTimeoutWaringRule from '../form/NewTimeoutWaringRule';
...
class ListTimeoutWaringRule extends React.Component {
  constructor(props) {
    super(props);
    ...
    return (
      <div >
          <Modal key={Math.random()}  maskClosable={false}
            ...
            <NewTimeoutWaringRule  id={currentId}  close={this.closeModal} />
          </Modal>
...
export default ListTimeoutWaringRule;

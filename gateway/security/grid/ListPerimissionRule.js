...
import NewPermissionRule from '../form/NewPermissionRule';
...
class ListPerimissionRule extends React.Component {
  constructor(props) {
    super(props);
    ...
    return (
      <div >
          <Modal key={Math.random()}  maskClosable={false}
            ...
            <NewPermissionRule  id={currentId}  close={this.closeModal} />
          </Modal>

        <Row style={{marginBottom:5}} gutter={0} >
          <Col span={12} >
            <ButtonGroup>
            <Button  type="primary" onClick={this.onActionClick.bind(this,'New')} icon="file-add" >新增权限规则</Button>
...
export default ListPerimissionRule;

...
import NewBlackWordSecurityRule from '../form/NewBlackWordSecurityRule';
...
class ListblackWordSecurityRule extends React.Component {
  constructor(props) {
    super(props);
    ...
    return (
      <div >
          <Modal key={Math.random()}  maskClosable={false}
            ...
            <NewBlackWordSecurityRule  id={currentId}  close={this.closeModal} />
          </Modal>

        <Row style={{marginBottom:5}} gutter={0} >
          <Col span={12} >
            <ButtonGroup>
            <Button  type="primary" onClick={this.onActionClick.bind(this,'New')} icon="file-add" >新增敏感字符配置</Button>
...
export default ListblackWordSecurityRule;

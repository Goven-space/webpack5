...
import NewSecurityScopeConfig from '../form/NewSecurityScopeConfig';

const Search = Input.Search;
const confirm = Modal.confirm;
const LIST_URL=URI.CORE_GATEWAY_SECURITY.scopelist;
const DELETE_URL=URI.CORE_GATEWAY_SECURITY.scopedelete;
const SAVE_URL=URI.CORE_GATEWAY_SECURITY.scopesave;
const ButtonGroup = Button.Group;

class ListSecurityScopeItems extends React.Component {
  constructor(props) {
    super(props);
    ...
    return (
      <div >
          <Modal key={Math.random()}  maskClosable={false}
            ...
            <NewSecurityScopeConfig  id={this.id} record={this.state.currentRecord} close={this.closeModal} />
          </Modal>
...
export default ListSecurityScopeItems;

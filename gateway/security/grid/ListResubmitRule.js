...
import NewResubmitRule from '../form/NewResubmitRule';
...
class ListResubmitRule extends React.Component {
  constructor(props) {
    super(props);
    ...
    return (
      <div >
          <Modal key={Math.random()}  maskClosable={false}
            ...
            <NewResubmitRule  id={currentId}  close={this.closeModal} />
          </Modal>

        <Row style={{marginBottom:5}} gutter={0} >
          <Col span={12} >
            <ButtonGroup>
            <Button  type="primary" onClick={this.onActionClick.bind(this,'New')} icon="file-add" >新增防重复提交规则</Button>
...
export default ListResubmitRule;

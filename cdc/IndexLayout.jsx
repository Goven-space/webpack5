...
import ListCDCConsumer from "./grid/ListCDCConsumer";
import ListCDCProducer from "./grid/ListCDCProducer";
import ListTopicManager from "./grid/ListTopicManager";
import HomeCharts from "./report/CDCHomeCharts";
...
class IndexLayout extends React.Component {
  ...
  render() {
    ...
    if (menuId === "home") {
      title = "实时数据/应用首页";
      content = <HomeCharts appId={this.appId} />;
    } else if (menuId === "ListCDCConsumer") {
      title = "实时数据/增量数据消费";
      content = <ListCDCConsumer appId={this.appId} />;
    } else if (menuId === "ListCDCProducer") {
      title = "实时数据/增量数据采集";
      content = <ListCDCProducer appId={this.appId} />;

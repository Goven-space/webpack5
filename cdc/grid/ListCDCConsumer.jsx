...
import NewCDCConsumer from '../form/NewCDCConsumer';
import ListCDCConsumerRecord from './ListCDCConsumerRecord';

const ButtonGroup = Button.Group;
const Search = Input.Search;
const TabPane = Tabs.TabPane;
const confirm = Modal.confirm;
const LIST_URL  = host+"/rest/cdc/consumer/list";
const DELETE_URL= host+"/rest/cdc/consumer/delete";
const EXPORT_URL= host+"/rest/cdc/consumer/export";
const START_URL = host+"/rest/cdc/consumer/start";
const CLOSE_URL = host+"/rest/cdc/consumer/close";

class ListCDCConsumer extends React.Component {
  constructor(props) {
    super(props);
  ...
  addTabPane=(id,name,record)=>{
      ...
      let content;
      if(id==='New'){
        content=(<NewCDCConsumer id="" appId={this.props.appId}  close={this.closeCurrentTab} />);
      }else if(id==='Edit'){
        content=(<NewCDCConsumer id={record.id} appId={this.props.appId}  close={this.closeCurrentTab} />);
      }
  ...
  render(){
    ...
    const expandedRow=(record)=>{
      return (
        <ListCDCConsumerRecord parentId={record.id} />
        );
    }
    ...
    return (
      <span>
            <Tabs
              ...
              hideAdd={true}
            >
            <TabPane tab="消息订阅列表" key="home" style={{padding:'0px'}}>
              <Row style={{marginBottom:5}} gutter={0} >
                <Col span={12} >
                <ButtonGroup>
                  <Button  type="primary" onClick={this.onActionClick.bind(this,'New')} icon="plus"  >新增订阅</Button>
...
export default ListCDCConsumer;

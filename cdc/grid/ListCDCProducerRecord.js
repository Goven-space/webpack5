...
const LIST_URL  = CDCURI.PRODUCER_RECORD.list; //分页显示
const CLEAR_URL = CDCURI.PRODUCER_RECORD.clear;//删除

class ListCDCProducerRecord extends React.Component {
  constructor(props) {
    super(props);
...
export default ListCDCProducerRecord;

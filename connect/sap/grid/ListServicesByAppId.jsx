...
const LIST_URL=URI.LIST_CORE_SERVICES.listSelfApi;
  ...
  render(){
    ...
    const expandedRow=(record)=>{
      return (
        ...
        <EditParamsConfig appId={this.appId} id={record.id} annotation='0' openapi='0' hystrix='0' beanId={record.beanId} modelId={record.modelId} closeTab={this.closeCurrentTab}/>
        </Card>
        );
    }
    const columns=[{
        ...
        render: (text,record) => {
          return <Dropdown  overlay={
            <Menu style={{width:60}}>
                ...
                <Menu.Item><a  onClick={this.onActionClick.bind(this,"ListDataMappingCategory",record)} >映射</a></Menu.Item>
    ...
    return (
      <div>
          <Modal key={Math.random()} title="绑定权限" maskClosable={false}
                width='750px'
                style={{ top: 25 }}

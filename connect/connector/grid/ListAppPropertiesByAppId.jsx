...
import NewAppProperties from '../../../designer/designer/form/NewAppProperties';
    ...
    return (
      <div style={{minHeight:600,margin:'5px'}}>
            ...
            <Row style={{marginBottom:5}} gutter={0} >
              <Col span={12} >
              <ButtonGroup>
                <Button  type="primary" onClick={this.onActionClick.bind(this,'New')} icon="plus"  >新增配置</Button>

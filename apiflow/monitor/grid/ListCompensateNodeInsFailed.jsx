...
class ListCompensateNodeInsFailed extends React.Component {
  constructor(props) {
    super(props);
    this.appId=this.props.appId;
    this.applicationId=this.props.applicationId;
    this.url=LIST_URL+"?compensateFlag=9&applicationId="+this.applicationId;
    this.startDate='';
    this.endDate='';
    this.state={
    ...
    return (
      <div>
          <Row style={{marginBottom:5}} gutter={0} >
            <Col span={8} >
            <ButtonGroup>
              <Button  type="ghost" onClick={AjaxUtils.showConfirm.bind(this,"立即进行补偿","确定要立即补偿选中流程吗?",this.runProcessCompensate)}  disabled={!hasSelected} icon="safety"   >手动补偿</Button>
...
export default ListCompensateNodeInsFailed;

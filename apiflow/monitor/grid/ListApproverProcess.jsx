...
const RUN_URL=URI.ESB.CORE_ESB_MONITOR.approveProcessInstance;
...
class ListApproverProcess extends React.Component {
  ...
  render(){
    ...
    return (
      <div>
            <Modal key={Math.random()} title='流程审批' maskClosable={false}
            ...
            <Tabs
              ...
              hideAdd={true}
            >
            <TabPane tab="待手动审批流程" key="home" style={{padding:'0px'}}>

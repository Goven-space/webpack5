...
const LIST_URL=URI.ESB.APPLICATION.listByPage;
const DELETE_URL=URI.ESB.APPLICATION.delete;
const DOWNLOAD_URL=URI.ESB.APPLICATION.download;
...
class ListApplicationsManager extends React.Component {
  constructor(props) {
    super(props);
    this.categoryId='ESBAppCategory';
    this.state={

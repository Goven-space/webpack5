...
const loadDataUrl=URI.ESB.APPLICATION.getById;
const saveDataUrl=URI.ESB.APPLICATION.save;
const listAppCategorysUrl=URI.CORE_CATEGORYNODE.listAllNodes+"?categoryId=ESBAppCategory&creatorOnly=1"
      ...
      <Form  >
        <Tabs size="large">
          <TabPane  tab="应用属性" key="props"  >
                <FormItem  label="所属分类"   {...formItemLayout4_16} help="请选择应用的所属分类,在应用管理中定义分类"  >
                  {
                ...
                <FormItem  label="应用Id"  {...formItemLayout4_16}  help='应用Id必须唯一,任意小写英文字母或数字组成，如果应用已经有设计元素修改应用Id会丢失设计元素' >
                  {
                    ...
                    (<Input placeholder="应用唯一id" maxLength={15}   />)
                  }
                </FormItem>
                <FormItem
                  label="版本"

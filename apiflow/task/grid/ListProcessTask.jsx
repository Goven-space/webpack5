...
const LIST_URL=URI.ESB.TASK.list;
const DELETE_URL=URI.ESB.TASK.delete;
const CLEAR_URL=URI.ESB.TASK.clear;
const CHAGESTATUS_URL=URI.ESB.TASK.changestatus;
...
class ListProcessTask extends React.Component {
  ...
  render(){
    ...
    const expandedRow=(record)=>{
      ...
      return (<ShowPorcessInstanceInfo record={record} processId={record.processId} transactionId={record.transactionId} />);
    }

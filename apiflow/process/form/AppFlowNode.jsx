import { Alert, Button, Collapse, Icon, Input, Modal, Popover, Radio, Tabs, Popconfirm, Switch, Tooltip } from "antd";
...
// 保存ESB节点
const SubmitUrl = URI.ESB.CORE_ESB_PROCESSNODE.save;
...
class AppFlowNode extends React.Component {
    ...
    editHandle = (data) => {
        ...
        this.refs.basic.setFieldsValue(basicValue);
    ...
    saveNode = () => {
        ...
        if(!configId){
            AjaxUtils.showError("请绑定连接器配置！");
            return;
        }
        const basicValue = this.refs.basic.getFieldsValue();
        let postData = {...basicValue};
        ...
        return (
            <div className="appflow-wrapper">
                <Modal
                    ...
                    onCancel={() => this.setState({ createVisible: false, errorTips: false })}
                ...
                <Tabs>
                    <Tabs.TabPane tab="配置" key="0" >
                        ...
                        <div style={{ marginTop: 15, padding: "0 16px" }}>

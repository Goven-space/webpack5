...
import DataTransformNodeParams from './components/DataTransformNodeParams';
              ...
              >
                ...
                (
                  <Select  >
                    ...
                    <Option value='4'>对HTTP传入参数进行转换</Option>
                  </Select>
                )}
              </FormItem>
          ...
          <TabPane  tab="转换规则" key="field" >
            <div>
              <DataTransformNodeParams
                ...
                />
              提示:直接指定字段id并选择一个规则进行数据转换,注意:转换规则必须返回一个字符串
            </div>
          </TabPane>
        </Tabs>

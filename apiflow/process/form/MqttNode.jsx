...
const connectionsUrl=URI.CORE_DATASOURCE.listAll+"?configType=mqtt";
        ...
        <Tabs size="large">
          <TabPane  tab="基本属性" key="props"  >
            ...
            <FormItem
              ...
              labelCol={{ span: 4 }}
              wrapperCol={{ span: 16 }}
              help="请选择一个Mqtt数据源(请在数据源管理中进行链接配置)"
            >{
              getFieldDecorator('dataSourceId',{rules: [{ required: true}],initialValue:'mqtt'})

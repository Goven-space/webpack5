...
class VariableNodeParams extends React.Component {
  ...
  render() {
    ...
    const columns=[{
      title: '参数id',
      dataIndex: 'paramsId',
      render: (text, record, index) => this.renderEditText(index,'paramsId', text,"支持JsonPath如$.data.pageNo"),
      width:'19%',
    },{
      title: '初始值',
      dataIndex: 'initValue',
      render: (text, record, index) =>this.renderEditText(index,'initValue',text,"数字或日期2020-03-05 10:11:00"),
      width:'17%',
    },{
      title: '增量',
      dataIndex: 'step',

        ...
        <Tabs size="large">
          <TabPane  tab="基本属性" key="props"  >
            ...
            <FormItem
              ...
              help='指定异步队列调度的并发线程数'
            >{
              getFieldDecorator('threadPoolNum',{rules: [{ required: true}],initialValue:"1"})
              (<InputNumber min={1} />)
              }
            </FormItem>
            <FormItem
              ...
              labelCol={{ span: 4 }}
              wrapperCol={{ span: 16 }}
              help='每个线程加入到线程池中的间隔时间(毫秒),间隔时间越大后继节点接收到的速率越慢'
            >{
              getFieldDecorator('sleepTime',{rules: [{ required: true}],initialValue:100})
              (<InputNumber min={0} />)
              }
            </FormItem>
            <FormItem
            ...
            >{
              getFieldDecorator('tip',{
                rules: [{ required: true}],
                initialValue:'流程已成功接收请求,等待业务进行处理!'
              })
              (<Input />)
              }
            </FormItem>

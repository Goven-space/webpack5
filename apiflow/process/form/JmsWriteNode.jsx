      ...
      <Form onSubmit={this.onSubmit} >
        <Tabs size="large">
          <TabPane  tab="基本属性" key="props"  >
            ...
            >{
              getFieldDecorator('dataSourceId',{rules: [{ required: true}],initialValue:'jms'})
            ...
            <FormItem
              ...
              labelCol={{ span: 4 }}
              wrapperCol={{ span: 16 }}
              help="指定要发送消息的topic或queud的id"
            >{
              getFieldDecorator('topic',{rules: [{ required: true}],initialValue:'esb'})
              (<Input  />)
              }
            </FormItem>

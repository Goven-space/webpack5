      ...
      <Form onSubmit={this.onSubmit} >
        <Tabs size="large">
          <TabPane  tab="基本属性" key="props"  >
            ...
            <FormItem label="流程终止" labelCol={{ span: 4 }} wrapperCol={{ span: 16 }} help='当有数据流先到达结束节点时是否终止整个流程执行' >
              {getFieldDecorator('processEndType',{initialValue:'3'})
              (
                <Select>
                  <Option value='2'>不结束流程</Option>
                  <Option value='3'>流程终止运行</Option>
                </Select>
              )}
            </FormItem>
            <FormItem
...
const EndNode = Form.create()(form);

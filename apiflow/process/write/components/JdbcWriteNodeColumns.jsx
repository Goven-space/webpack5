...
const getColumnsByTableName=URI.ESB.DBTABLENODE.getTableFields;
...
class JdbcWriteNodeColumns extends React.Component {
  ...
  render() {
    ...
    const columns=[{
      ...
      title: '映射流字段',
      dataIndex: 'mappingFieldId',
      width:'15%',
      render: (text, record, index) => this.renderEditText(index, 'mappingFieldId', text,"如:id或$.data.id"),
    },{
      title: '为null时写入缺省值',

...
const LISTDATAS_URL=URI.ESB.DBTABLE_READNODE.previewSqlData;

//根据sql预览数据

class PreviewSqlReadNodeData extends React.Component {
  constructor(props) {
    super(props);
  ...
  loadSqlData=(pagination=this.state.pagination, filters={}, sorter={})=>{
    ...
    formData.nodeId=formData.pNodeId;
...
export default PreviewSqlReadNodeData;

...
class SelectDataMappingCategory extends React.Component {
  constructor(props) {
    super(props);
    this.appId=this.props.appId;
    this.applicationId=this.props.applicationId;
    this.url=LIST_URL+"?applicationId="+this.applicationId;
    this.selectedMappingCategory=this.props.selectedMappingCategory;
  ...
  onSelectChange = (selectedRowKeys,selectedRows) => {
   ...
   this.selectedMappingCategory(selectedRowKeys,selectedRows[0].configName);
  }
  ...
  render(){
    ...
    selectedRowKeys2[0]=this.state.selectedRowKeys[0]||this.categoryId;
    const rowSelection = {selectedRowKeys:selectedRowKeys2,onChange: this.onSelectChange,type:'radio'};
...
export default SelectDataMappingCategory;

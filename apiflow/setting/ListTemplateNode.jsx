...
const LIST_URL=URI.ESB.CORE_ESB_NODETEMPLATE.list; //分页显示
const DELETE_URL=URI.ESB.CORE_ESB_NODETEMPLATE.delete;//删除
const exportConfigUrl=URI.ESB.CORE_ESB_NODETEMPLATE.exportConfig;

...
const MenuUrl = URI.CORE_APIPORTAL_APICATEGORY.ListApplicationMenusUrl;

class ApplicationLeftMenu_all extends React.Component {
  constructor(props) {
    super(props);
      ...
      <Spin spinning={this.state.mask} tip="Loading..." >
        ...
        >
            ...
            <Menu.Item key="approverApis" >
              ...
              <span style={{fontSize:'14px'}} >API调用申请<Badge count={this.state.reqCount} overflowCount={999}  style={{ backgroundColor: '#52c41a' }} /></span>
            </Menu.Item>
            {menus}
        </Menu>
        </Spin>
...
export default ApplicationLeftMenu_all;

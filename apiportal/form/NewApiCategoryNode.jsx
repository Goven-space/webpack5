...
const loadDataUrl=URI.CORE_APIPORTAL_APICATEGORY.GetById;
const saveDataUrl=URI.CORE_APIPORTAL_APICATEGORY.Save;
const ListTreeSelectDataUrl=URI.CORE_APIPORTAL_APICATEGORY.ListTreeSelectDataUrl;
        ...
        >
          {
            ...
            (<TreeNodeSelect  url={this.treeNodeSelctUrl} labelId='label' valueId='value' options={{dropdownStyle:{maxHeight: 400, overflow: 'auto' }}} />)
          }
        </FormItem>
        <FormItem
          label="分类名称"
...
const NewApiCategoryNode = Form.create()(form);

export default NewApiCategoryNode;

...
class NewTestInParamsJson extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      curEditIndex:-1,
...
//设置数据
  ...
  render() {
    ...
    const columns=[{
      ...
      render: (text, record, index) => this.renderEditText(index,'paramsType', text),
      width:'10%',
    },{
      title: '必填',
      dataIndex: 'required',
      width:'8',
      render:(text,record)=>{if(text){return (<div style={{color:'red'}}>是</div>);}else{return "否"}}
    },{
      title: '默认值',
...
export default NewTestInParamsJson;

...
class ListApiByManager extends React.Component {
  ...
  loadData=(pagination=this.state.pagination, filters={}, sorter={})=>{
    ...
    if(this.appId=='*'){
      filters.registerFlag=[1];  //所有注册API列表
    }
  ...
  addTabPane=(id,name,record)=>{
      ...
      if(id==='NewService'){
        ...
        if(record.configType==='REG'){
          content=(<RegService appId={this.appId} id={record.id} closeTab={this.closeCurrentTab}/>);
        }else if(record.configType==='WEBSERVICE'){
          content=(<RegWebService appId={this.appId} id={record.id} closeTab={this.closeCurrentTab}/>);
        }else if(record.configType==='DUBBO'){
          content=(<RegDubbo appId={this.appId} id={record.id} closeTab={this.closeCurrentTab}/>);
        }else if(record.configType==='RestToWebService'){
          content=(<RegRestToWebService appId={this.appId} id={record.id} closeTab={this.closeCurrentTab}/>);
          ...
          content=(<NewJoinService appId={this.appId} id={record.id} closeTab={this.closeCurrentTab}/>);
        }else{
          content=(<NewService appId={this.appId} id={record.id} closeTab={this.closeCurrentTab}/>);
        }
      }else if(id==='Test'){
        //服务测试

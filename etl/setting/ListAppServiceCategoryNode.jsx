...
class ListAppServiceCategoryNode extends React.Component {
  constructor(props) {
    super(props);
    this.categoryId=this.props.categoryId;
    this.appId=this.props.appId;
    this.applicationId=this.props.applicationId;
    this.rootName=this.props.rootName||'分类管理';
    this.state={
  ...
  loadData=(pagination=this.state.pagination, filters={}, sorter={})=>{
    let url=LIST_URL+"?categoryId="+this.categoryId+"&creatorOnly=false&rootName="+this.rootName;
    ...
    return (
      <div >
        <Modal key={Math.random()} title="分类属性" maskClosable={false}
            ...
            <NewServiceCategoryNode id={currentId} appId={this.appId} applicationId={this.applicationId} rootName={this.rootName} categoryId={this.categoryId} parentNodeId={parentNodeId} closeModal={this.closeModal} />
        </Modal>
        <div style={divStyle}>
            <ButtonGroup   >
...
export default ListAppServiceCategoryNode;

...
class HomePageProcessReport extends React.Component {
  ...
  search=(value)=>{
    ...
    let url=this.url+"?applicationId="+this.applicationId;
  ...
  render(){
    ...
    const columns=[
      ...
      dataIndex: 'errorNum',
      width: '6%',
      render: (text,record) => {return <a onClick={this.detailClick.bind(this,'failedProcessIns',record.processId)} style={{fontSize:'16px',color:'#f50'}} >{text}</a>}
    },{
        title: '今日插入',

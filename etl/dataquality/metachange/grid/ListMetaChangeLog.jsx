...
const LIST_URL=URI.ETL.DATAQUALITY_METACHANGE_HISTORYLOG.list;
const DELETE_URL=URI.ETL.DATAQUALITY_METACHANGE_HISTORYLOG.delete;

class ListMetaChangeLog extends React.Component {
  constructor(props) {
    super(props);
...
export default ListMetaChangeLog;

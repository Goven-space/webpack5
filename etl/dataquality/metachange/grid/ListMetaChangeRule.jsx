...
import NewMetaChangeRule from '../form/NewMetaChangeRule';
import ListMetaChangeLog from './ListMetaChangeLog';
...
const LIST_URL=URI.ETL.DATAQUALITY_METACHANGE.list;
const DELETE_URL=URI.ETL.DATAQUALITY_METACHANGE.delete;
const RUN_URL=URI.ETL.DATAQUALITY_METACHANGE.run;
const startTaskJobUrl=URI.ETL.DATAQUALITY_METACHANGE.start;
const stopTaskJobUrl=URI.ETL.DATAQUALITY_METACHANGE.stop;

class ListMetaChangeRule extends React.Component {
  constructor(props) {
    super(props);
      ...
      const expandedRow=(record)=>{
        return (
          <div style={{width:this.state.width,backgroundColor:'#ffffff',border:'1px solid #f4f4f4',padding:8}}>
                <ListMetaChangeLog id={record.id} />
          </div>
          );
      }
    ...
    return (
      <div >
    	          <Modal key={Math.random()} maskClosable={false}
                    ...
                    <NewMetaChangeRule id={currentId} appId={this.props.appId} applicationId={this.applicationId} categoryId={this.categoryId} close={this.closeModal} />
                </Modal>
...
export default ListMetaChangeRule;

...
const LIST_URL=URI.ETL.DATAQUALITY_DATACONTENT_HISTORYLOG.list;
const DELETE_URL=URI.ETL.DATAQUALITY_DATACONTENT_HISTORYLOG.delete;

class ListDataContentLog extends React.Component {
  constructor(props) {
    super(props);
  ...
  render(){
    ...
    const columns=[{
        ...
        width: '10%'
          ...
          width: '10%',
          render:(text,record)=>{
            return record.totalCount <= 0 ? "0%" : (Math.round(record.totalErrorCount / record.totalCount * 10000) / 100.00)+"%";
          }
      },{
        title: '开始时间',
        dataIndex: 'startTime',
        ...
        width: '15%',
          ...
          width: '30%',
          ellipsis: true,
          render: (text,record) => {return JSON.stringify(text);}
      },{
        title: '结果',
        dataIndex: 'result',
        width: '10%',
...
export default ListDataContentLog;

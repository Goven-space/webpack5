...
const LIST_URL=URI.ETL.DATAQUALITY_DATACOUNT_HISTORYLOG.list;
const DELETE_URL=URI.ETL.DATAQUALITY_DATACOUNT_HISTORYLOG.delete;

class ListDataCountLog extends React.Component {
  constructor(props) {
    super(props);
...
export default ListDataCountLog;

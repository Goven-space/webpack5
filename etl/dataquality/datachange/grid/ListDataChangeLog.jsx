...
const LIST_URL=URI.ETL.DATAQUALITY_DATACHANGE_HISTORYLOG.list;
const DELETE_URL=URI.ETL.DATAQUALITY_DATACHANGE_HISTORYLOG.delete;

class ListDataChangeLog extends React.Component {
  constructor(props) {
    super(props);
...
export default ListDataChangeLog;

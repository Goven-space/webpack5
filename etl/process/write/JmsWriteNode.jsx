...
const connectionsUrl=URI.CORE_DATASOURCE.listAll+"?configType=jms";
        ...
        <Tabs size="large">
          <TabPane  tab="基本属性" key="props"  >
            ...
            <FormItem
              ...
              labelCol={{ span: 4 }}
              wrapperCol={{ span: 16 }}
              help="请选择一个JMS数据源(请在数据源管理中进行链接配置)"
            >{
            ...
            >
              ...
              (
                <RadioGroup>
                  <Radio value='topic'>主题(topic)</Radio>
                  <Radio value='queue'>队列(queue)</Radio>
                </RadioGroup>
              )}
            </FormItem>
            <FormItem

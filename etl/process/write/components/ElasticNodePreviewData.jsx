...
const LISTDATAS_URL=URI.ETL.ElasticsearchNode.previewdata;

class ElasticNodePreviewData extends React.Component {
  constructor(props) {
    super(props);
...
export default ElasticNodePreviewData;

...
const LISTDATAS_URL=URI.ETL.METADATA_WRITE_NODE.previewData;

class MetaDataWriteNodePreview extends React.Component {
  constructor(props) {
    super(props);
...
export default MetaDataWriteNodePreview;

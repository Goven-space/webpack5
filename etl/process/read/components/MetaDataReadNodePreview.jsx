...
const LISTDATAS_URL=URI.ETL.METADATAREADNODE.previewSqlData;

class MetaDataReadNodePreview extends React.Component {
  constructor(props) {
    super(props);
...
export default MetaDataReadNodePreview;

...
const getProcessInfoUrl=URI.ETL.MONITOR.instanceinfo;
const historyinfo=URI.ETL.MONITOR.historyinfo;
...
export default class ProcessMonitorFrame extends React.Component {
  constructor(props) {
    ...
    this.url=getProcessInfoUrl+"?processId="+this.processId+"&transactionId="+this.transactionId+"&logDbName="+this.logDbName;
    this.intervalId;
...
playProcess=()=>{
  this.setState({mask:true});
  let winobj =this.refs.iframe.contentWindow;
  let url=historyinfo+"?transactionId="+this.transactionId+"&logDbName="+this.logDbName;

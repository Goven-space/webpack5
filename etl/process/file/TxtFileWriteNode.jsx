        ...
        <Tabs size="large">
          <TabPane  tab="基本属性" key="props"  >
              ...
              <FormItem
                ...
                wrapperCol={{ span: 16 }}
              >{
                getFieldDecorator('dataType',{initialValue:'txt'})
                (
                  <RadioGroup>
                    <Radio value='txt'>逗号分隔输出</Radio>
              ...
              <FormItem label="输出头" labelCol={{ span: 4 }} wrapperCol={{ span: 16 }}
                 help='配置的字段名输出到文件的第一行'
                 style={{display:this.props.form.getFieldValue("dataType")==='txt'?'':'none'}}
              >
                {getFieldDecorator('outputHeader',{initialValue:'1'})
                (
                  <RadioGroup>
              ...
              >
                {getFieldDecorator('fileName',{rules: [{ required: true}],initialValue:'test.txt'})
                (
                  (<Input />)
                )}
              </FormItem>

...
const saveDataUrl=URI.ETL.EXCEL_READ_NODE.getExcelHead;
...
class form extends React.Component{
  ...
  onSubmit = () => {
    if(this.state.fileList.length<1){
      AjaxUtils.showError("请选择一个Excel文件再提交!");
      return;
    }
    if(this.state.fileList.length>1){
  ...
  render() {
    ...
    return (
      ...
      <Form style={{marginRight:'20px'}}>
	     <FormItem  label="Excel文件"  {...formItemLayout4_16}>
          <Upload {...uploadProps}>
            <Button>

...
import UploadDBFFile from './UploadDBFFile';
...
class DBFReadNodeColumns extends React.Component {
  constructor(props) {
    super(props);
 ...
 downRecord = (arr, index) => {
  ...
  render() {
    ...
    return (
      <div>
          <Modal key={Math.random()} title='上传DBF文件' maskClosable={false}
              visible={this.state.visible}
              footer=''
              width='760px'
              onOk={this.handleCancel}
              onCancel={this.handleCancel} >
              <UploadDBFFile sheetName={this.form.getFieldValue("sheetName")} loadTableColumns={this.loadTableColumns} />
          </Modal>
          <div style={{paddingBottom:10}} >
              <ButtonGroup >
              <Button type='primary' onClick={this.showDBFForm}  icon="select"  >从DBF中分析字段</Button>
...
export default DBFReadNodeColumns;

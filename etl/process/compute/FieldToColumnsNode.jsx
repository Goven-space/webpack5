...
import FieldToColumnsConfig from './components/FieldToColumnsConfig';
      ...
      <Form onSubmit={this.onSubmit} >
        <Tabs size="large">
          <TabPane  tab="基本属性" key="props"  >
              ...
              <FormItem
                label="分隔符"
                help='指定字段值中的进行拆分的分隔符(如果是换行符请填写:line.separator)'
                labelCol={{ span: 4 }}
                wrapperCol={{ span: 16 }}
              >{
              ...
              <FormItem label="删除原字段" labelCol={{ span: 4 }} wrapperCol={{ span: 16 }}
                 help='拆分后删除被拆分的字段'
              >
                {getFieldDecorator('deleteSourceFieldId',{initialValue:'1'})
                (
                  <RadioGroup>
              ...
              <FormItem label="正则表达式" labelCol={{ span: 4 }} wrapperCol={{ span: 16 }}
                 help='分隔符是一个正则表达式'
              >
          ...
          <TabPane  tab="字段配置" key="event"  >
            <FieldToColumnsConfig

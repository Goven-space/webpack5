...
import DataSecurityFieldConfig from './components/DataSecurityFieldConfig';
      ...
      <Form onSubmit={this.onSubmit} >
        <Tabs size="large">
          <TabPane  tab="基本属性" key="props"  >
              ...
              <FormItem
                label="最大脱敏记录数"
                help='只对符合条件的top n条记录进行脱敏,0表示不限定'
                labelCol={{ span: 4 }}
                wrapperCol={{ span: 16 }}
              >{
          ...
          <TabPane  tab="脱敏规则" key="field" >
            <div>
              <DataSecurityFieldConfig

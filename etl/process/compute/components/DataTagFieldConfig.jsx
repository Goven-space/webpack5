...
class DataTagFieldConfig extends React.Component {
  constructor(props) {
    super(props);
  ...
  insertRow=()=>{
    ...
    let newRow={key:key,transfer:true,colType:'data'};
    newData.push(newRow);
  ...
  render() {
    ...
    let columns=[{
      ...
      dataIndex: 'colValue',
      width:'50%',
      render: (text, record, index) => this.renderEditText(index,'colValue', text,record,'${变量}可以引用变量'),
    },{
      title: '删除',
      dataIndex: 'action',
      width:'10%',
    ...
    return (
      <div  >
              ...
              <ButtonGroup >
                <Button type='primary'  onClick={this.insertRow} icon="plus"  >新增标注字段</Button>
...
export default DataTagFieldConfig;

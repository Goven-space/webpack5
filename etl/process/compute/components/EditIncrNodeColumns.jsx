...
const prevNodeColumnsConfigUrl=URI.ETL.PROCESSNODE.prevnodeColumnsConfig;
const Option = Select.Option;
const ButtonGroup = Button.Group;

class EditIncrNodeColumns extends React.Component {
  constructor(props) {
    super(props);
  ...
  loadTableColumns=()=>{
    ...
    let url=prevNodeColumnsConfigUrl+"?processId="+this.processId+"&nodeId="+sourceNodeIds;
    ...
    return (
      <div>
          <div style={{paddingBottom:10}} >
              <ButtonGroup >
              <Button type='primary' onClick={this.loadTableColumns} icon="select"  >导入源数据节点字段</Button>
...
export default EditIncrNodeColumns;

...
import ColumnToRowsFieldConfig from './components/ColumnToRowsFieldConfig';
      ...
      <Form onSubmit={this.onSubmit} >
        <Tabs size="large">
          <TabPane  tab="基本属性" key="props"  >
              ...
              <FormItem label="Key字段Id"
                labelCol={{ span: 4 }}
                wrapperCol={{ span: 16 }}
                help='指定Key字段Id,会在每行中新增加一列用来存储转换前字段的值类型或者说明'
              >
          ...
          <TabPane  tab="字段设置" key="event"  >
            <ColumnToRowsFieldConfig

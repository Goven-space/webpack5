    ...
    <Spin spinning={this.state.mask} tip="Loading..." >
      ...
      <Tabs size="large"  onChange={this.onTabsChange} >
        <TabPane  tab="基本属性" key="props"  >
            ...
            <FormItem label="转换范围" labelCol={{ span: 4 }} wrapperCol={{ span: 16 }}
              help="指定要把内存流数据转换为XML字段"
            >
              {getFieldDecorator('rangeFlag',{initialValue:'0'})
              (
                <RadioGroup>
                  <Radio value='0'>所有数据转为XML(包含变量)</Radio>
                  <Radio value='1'>仅转换Data数据体中的数据</Radio>
                </RadioGroup>
              )}
            </FormItem>
            <FormItem
              ...
              labelCol={{ span: 4 }}
              wrapperCol={{ span: 16 }}
              help='转换为XML后指定要存储XML字符串的字段,在后继节点中可以获取这个字段来读取XML字符串,支持JsonPath指定路径'
            >{
              getFieldDecorator('fieldId',{rules: [{ required: true}],initialValue:"$.xmlbody"})
              (<Input   />)
              }
            </FormItem>

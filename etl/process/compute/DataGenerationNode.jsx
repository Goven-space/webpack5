...
import DataGenerationNodeConfig from './components/DataGenerationNodeConfig';
        ...
        <Tabs size="large">
          <TabPane  tab="基本属性" key="props"  >
              ...
              <FormItem
                ...
                wrapperCol={{ span: 16 }}
              >{
                getFieldDecorator('maxCount',{rules: [{ required:false}],initialValue:1000})
                (<InputNumber min={1}  />)
                }
              </FormItem>
              <FormItem
          ...
          <TabPane  tab="字段配置" key="field" >
            <div>
              <DataGenerationNodeConfig

      ...
      <Form onSubmit={this.onSubmit} >
        <Tabs size="large">
          <TabPane  tab="基本属性" key="props"  >
              ...
              <FormItem label="合并选项" labelCol={{ span: 4 }} wrapperCol={{ span: 16 }}
                help="选择合并后的数据处理方式"
              >
                {getFieldDecorator('mergeOption',{initialValue:'0'})
                (
                  <RadioGroup>
                    <Radio value='0'>合并后删除原有数据行</Radio>
                    <Radio value='1'>合并后的数据追加到最后一行</Radio>
                  </RadioGroup>
                )}
              </FormItem>
              <FormItem

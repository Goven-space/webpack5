...
const loadDataUrl=URI.LIST_MONITOR_CENTER.errorcodeReport;

//错误码统计

class ErrorCodeCharts extends React.Component{
  constructor(props){
    super(props);
  ...
  render() {
    ...
    let htmlCode='<div style="color:#8c8c8c;font-size:1.16em;text-align: center;width: 10em;">错误码占比</div>';
    return (
...
export default ErrorCodeCharts;

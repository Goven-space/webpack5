...
class EditJSCode extends React.Component{
  constructor(props){
    super(props);
    ...
    this.codeType=this.props.codeType||"javascript"; //代码类型
    ...
    return (
      <Spin spinning={this.state.mask} tip="Loading..." >
          ...
          <div style={{margin:'0 0 5px 0',padding:'5px',border:'solid 1px #ccc',borderRadius:'5px'}}>
            <ButtonGroup>
              <Button type="primary" icon='save' onClick={this.saveCode}>保存代码(Ctr+S)</Button>
            </ButtonGroup>
          </div>

    ...
    return (
      <Spin spinning={this.state.mask} tip="Loading..." >
        <Form onSubmit={this.onSubmit} >
          ...
          <FormItem label="VirtualHost" labelCol={{ span: 4 }} wrapperCol={{ span: 16 }}
            help='VirtualHost'
          >
            {getFieldDecorator('virtualHost', {
              initialValue: '/',
              rules: [{ required: true }]
            })
...
const NewRabbitMQDatasource = Form.create()(form);

export default NewRabbitMQDatasource;

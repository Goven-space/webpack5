...
class RightHome extends React.Component{
  ...
  openUrl=(id,title)=>{
    this.menuClick(id+"#"+title,this.categoryId);
  }
    ...
    return (
      <Spin spinning={this.state.mask} tip="Loading..." >
        <List
          ...
          renderItem={item => (
            <List.Item>
              <Card hoverable={true} style={{padding:'3px 0 3px 0',overflow:'hidden',height:'110px',backgroundColor:item.backgroundColor||'#fff'}} onClick={this.openUrl.bind(this,item.id,item.title)} >
              <Meta

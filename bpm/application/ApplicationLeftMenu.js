...
const listCategorys=URI.BPM.APPLICATION.menuCategorys;
...
class ApplicationLeftMenu extends React.Component{
  ...
  render() {
    return (
      ...
      >
        <SubMenu key="APPDesigner"  title={<span><Icon type="appstore" style={{fontSize:'14px'}} /><span style={{fontSize:'14px'}} >流程应用</span></span>}>

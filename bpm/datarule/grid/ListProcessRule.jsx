...
const LIST_URL=URI.BPM.CORE_BPM_RULE.list;
const DELETE_URL=URI.BPM.CORE_BPM_RULE.delete;
const SubmitUrl=URI.BPM.CORE_BPM_RULE.save;
const exporUrl=URI.BPM.CORE_BPM_RULE.export;
...
class ListProcessRule extends React.Component {
  ...
  addTabPane=(id,name,record)=>{
      ...
      if(id==='New'){
        ...
        content=<EditJavaCode  code={record.ruleCode} record={record} beanId={record.classPath} saveEditCode={this.saveEditCode} templateType="ESBProcessRule" applicationId={this.applicationId} />;
      }
    ...
    return (
            ...
            <TabPane tab="规则列表" key="home" style={{padding:'0px'}}>
              <Row style={{marginBottom:5}} gutter={0} >
                <Col span={12} >
                <ButtonGroup>
                  <Button  type="primary" onClick={this.onActionClick.bind(this,'New')} icon="plus"  >新增规则</Button>

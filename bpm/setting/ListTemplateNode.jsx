...
const LIST_URL=URI.BPM.CORE_BPM_NODETEMPLATE.list; //分页显示
const DELETE_URL=URI.BPM.CORE_BPM_NODETEMPLATE.delete;//删除
const exportConfigUrl=URI.BPM.CORE_BPM_NODETEMPLATE.exportConfig;

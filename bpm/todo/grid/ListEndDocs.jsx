    ...
    const columns=[
      {
        ...
        width:'10%'
          ...
          width: '35%',
          render: (text,record) => {
              return <a onClick={this.openForm.bind(this,record)}>{text}</a>
          }
      },{
        title: '流程名称',

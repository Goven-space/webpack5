...
const LIST_URL=URI.BPM.CORE_BPM_REPORT.listProcessRunReport;
    ...
    const columns=[
      {
        ...
        dataIndex: 'totalNum',
        width: '8%',
        render: (text,record) => {return <a  style={{fontSize:'16px'}} >{text}</a>}
      },{
          title: '审批中',
          dataIndex: 'currentNum',
          width: '8%',
          render: (text,record) => {return <a  style={{fontSize:'16px',color:'green'}} >{text}</a>}
      },{
      title: '已超时',
      dataIndex: 'delayNum',
      width: '8%',
      render: (text,record) => {return <a style={{fontSize:'16px',color:'#f50'}} >{text}</a>}
    },{
        title: '已结束',
        dataIndex: 'endNum',
        width: '8%',
        render: (text,record) => {return <a  style={{fontSize:'16px',color:'#000'}} >{text}</a>}
    },{
        title: '平均耗时',
        dataIndex: 'avgTime',
        width: '10%',

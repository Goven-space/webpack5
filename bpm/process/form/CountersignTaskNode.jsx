...
const defaultActionIds=[
  ...
  {actionId:"countersignAgree",actionName:"同意",visible:true},
  {actionId:"countersignRefuse",actionName:"不同意",visible:true},
];
      ...
      <Form onSubmit={this.onSubmit} >
        <Tabs size="large">
          <TabPane  tab="基本属性" key="props"  >
            ...
            <FormItem label="会签顺序" labelCol={{ span: 4 }} wrapperCol={{ span: 16 }}>
              {getFieldDecorator('countersignSerial',{initialValue:'0'})
              (
                <RadioGroup>
                  <Radio value='0'>并行</Radio>
                  <Radio value='1'>串行</Radio>
                </RadioGroup>
              )}
            </FormItem>
            <FormItem label="会签类型" labelCol={{ span: 4 }} wrapperCol={{ span: 16 }}>
              {getFieldDecorator('countersignType',{initialValue:'0'})
              (
                <RadioGroup>
                  <Radio value='0'>仅签署意见</Radio>
                  <Radio value='1'>由最后会签者决定</Radio>
                  <Radio value='2'>一票否决</Radio>
                  <Radio value='3'>自定义通过比例</Radio>
                </RadioGroup>
              )}
            </FormItem>
            <FormItem
              ...
              labelCol={{ span: 4 }}
              wrapperCol={{ span: 16 }}
              style={{display:this.props.form.getFieldValue("countersignType")=='3'?"":"none"}}
              help='超过本比例则表示会签结果为通过'
            >{
              getFieldDecorator('percentage',{rules: [{ required: true}],initialValue:"50"})
              (<InputNumber min={50} />)
              }
            </FormItem>
            <FormItem

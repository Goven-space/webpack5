...
function chooseNodeObjFromType(type, p) {
	...
	switch(type) {
		...
		case 'sqlReadNode':
					...
					nodeObj.cla = "defaultReadNode moveLight";
					nodeObj.nodeType = 'sqlReadNode';
					nodeObj.text = "表数据输入";
		...
		case 'eventNode':
					nodeObj.newId = getNextNodeId('E');
					nodeObj.cla = "defaultNode moveLight";
					nodeObj.nodeType = 'eventNode';
					nodeObj.text = "规则";
					nodeObj.bgColor = '#ccab26';
					break;
		case 'sqlWriteNode':
					nodeObj.newId = getNextNodeId('E');
					nodeObj.cla = "defaultWriteNode moveLight";
					nodeObj.nodeType = 'poolNode';
					nodeObj.text = "";
					nodeObj.bgColor = '#ccab26';
					break;
		case 'jdbcWriteNode':
					nodeObj.newId = getNextNodeId('T');
					nodeObj.cla = "defaultWriteNode moveLight";
					nodeObj.nodeType = 'jdbcWriteNode';
					nodeObj.text = "数据表输出";
					nodeObj.bgColor = '#ccab26';
					break;
		case 'msgNode':
		...
		case 'subProcess':
					...
					nodeObj.cla = "subProcess moveLight";
					nodeObj.nodeType = 'subProcess';
					nodeObj.text = "子流程";
					nodeObj.bgColor = '#fceb00';
					nodeObj.icon = '';
					break;
		case 'textNode':
					nodeObj.newId = getNextNodeId('E');
		...
		case 'metaDataReadNode':
					nodeObj.newId = getNextNodeId('T');
					nodeObj.cla = "defaultReadNode moveLight";
					nodeObj.nodeType = 'metaDataReadNode';
					nodeObj.text = GoalNodeName;
					nodeObj.bgColor = '#fff';
					break;
		case 'tableBatchReadNode':
					nodeObj.newId = getNextNodeId('T');
					nodeObj.cla = "defaultReadNode moveLight";
					nodeObj.nodeType = 'tableBatchReadNode';
					nodeObj.text = GoalNodeName;
					nodeObj.bgColor = '#fff';
					break;
		case 'mongoDbReadNode':
					nodeObj.newId = getNextNodeId('T');
					nodeObj.cla = "defaultReadNode moveLight";
					nodeObj.nodeType = 'mongoDbReadNode';
					nodeObj.text = GoalNodeName;
					nodeObj.bgColor = '#fff';
					break;
		case 'middleDbReadNode':
					nodeObj.newId = getNextNodeId('T');
					nodeObj.cla = "defaultReadNode moveLight";
					nodeObj.nodeType = 'middleDbReadNode';
					nodeObj.text = GoalNodeName;
					nodeObj.bgColor = '#fff';
					break;
		case 'redisReadNode':
					nodeObj.newId = getNextNodeId('T');
					nodeObj.cla = "defaultReadNode moveLight";
					nodeObj.nodeType = 'redisReadNode';
					nodeObj.text = GoalNodeName;
					nodeObj.bgColor = '#fff';
					break;
		case 'kafkaReadNode':
					nodeObj.newId = getNextNodeId('T');
					nodeObj.cla = "defaultReadNode moveLight";
					nodeObj.nodeType = 'kafkaReadNode';
					nodeObj.text = GoalNodeName;
					nodeObj.bgColor = '#fff';
					break;
		case 'excelReadNode':
					nodeObj.newId = getNextNodeId('T');
					nodeObj.cla = "defaultReadNode moveLight";
					nodeObj.nodeType = 'excelReadNode';
					nodeObj.text = GoalNodeName;
					nodeObj.bgColor = '#fff';
					break;
		case 'elasticReadNode':
					nodeObj.newId = getNextNodeId('T');
					nodeObj.cla = "defaultReadNode moveLight";
					nodeObj.nodeType = 'elasticReadNode';
					nodeObj.text = GoalNodeName;
					nodeObj.bgColor = '#fff';
					break;
		case 'dataGenerationNode':
					nodeObj.newId = getNextNodeId('T');
					nodeObj.cla = "defaultReadNode moveLight";
					nodeObj.nodeType = 'dataGenerationNode';
					nodeObj.text = GoalNodeName;
					nodeObj.bgColor = '#fff';
					break;
		case 'sftpReadNode':
					nodeObj.newId = getNextNodeId('T');
					nodeObj.cla = "defaultReadNode moveLight";
					nodeObj.nodeType = 'sftpReadNode';
					nodeObj.text = GoalNodeName;
					nodeObj.bgColor = '#fff';
					break;
		case 'apiDownloadNode':
					nodeObj.newId = getNextNodeId('T');
					nodeObj.cla = "defaultReadNode moveLight";
					nodeObj.nodeType = 'apiDownloadNode';
					nodeObj.text = GoalNodeName;
					nodeObj.bgColor = '#fff';
					break;
		case 'txtFileReadNode':
					nodeObj.newId = getNextNodeId('T');
					nodeObj.cla = "defaultReadNode moveLight";
					nodeObj.nodeType = 'txtFileReadNode';
					nodeObj.text = GoalNodeName;
					nodeObj.bgColor = '#fff';
					break;
		case 'metaDataWriteNode':
					nodeObj.newId = getNextNodeId('T');
					nodeObj.cla = "defaultWriteNode moveLight";
					nodeObj.nodeType = 'metaDataWriteNode';
					nodeObj.text = "";
					nodeObj.bgColor = '#fff';
					break;
		case 'readFilePathNode':
					nodeObj.newId = getNextNodeId('T');
					nodeObj.cla = "defaultReadNode moveLight";
					nodeObj.nodeType = 'readFilePathNode';
					nodeObj.text = "";
					nodeObj.bgColor = '#fff';
					break;
		case 'moveFileNode':
					nodeObj.newId = getNextNodeId('T');
					nodeObj.cla = "defaultWriteNode moveLight";
					nodeObj.nodeType = 'moveFileNode';
					nodeObj.text = "";
					nodeObj.bgColor = '#fff';
					break;
		case 'tableBatchWriteNode':
					nodeObj.newId = getNextNodeId('T');
					nodeObj.cla = "defaultWriteNode moveLight";
					nodeObj.nodeType = 'tableBatchWriteNode';
					nodeObj.text = "";
					nodeObj.bgColor = '#fff';
					break;
		case 'dataOutputNode':
					nodeObj.newId = getNextNodeId('T');
					nodeObj.cla = "defaultWriteNode moveLight";
					nodeObj.nodeType = 'dataOutputNode';
					nodeObj.text = "";
					nodeObj.bgColor = '#fff';
					break;
		case 'mongoDbWriteNode':
					nodeObj.newId = getNextNodeId('T');
					nodeObj.cla = "defaultWriteNode moveLight";
					nodeObj.nodeType = 'mongoDbWriteNode';
					nodeObj.text = "";
					nodeObj.bgColor = '#fff';
					break;
		case 'apiWriteNode':
					nodeObj.newId = getNextNodeId('T');
					nodeObj.cla = "defaultWriteNode moveLight";
					nodeObj.nodeType = 'apiWriteNode';
					nodeObj.text = "";
					nodeObj.bgColor = '#fff';
					break;
		case 'middleDbWriteNode':
					nodeObj.newId = getNextNodeId('T');
					nodeObj.cla = "defaultWriteNode moveLight";
					nodeObj.nodeType = 'middleDbWriteNode';
					nodeObj.text = "";
					nodeObj.bgColor = '#fff';
					break;
		case 'kafkaWriteNode':
					nodeObj.newId = getNextNodeId('T');
					nodeObj.cla = "defaultWriteNode moveLight";
					nodeObj.nodeType = 'kafkaWriteNode';
					nodeObj.text = "";
					nodeObj.bgColor = '#fff';
					break;
		case 'jmsWriteNode':
		...
		case 'redisWriteNode':
					nodeObj.newId = getNextNodeId('T');
					nodeObj.cla = "defaultWriteNode moveLight";
					nodeObj.nodeType = 'redisWriteNode';
					nodeObj.text = "";
					nodeObj.bgColor = '#fff';
					break;
		case 'excelWriteNode':
					nodeObj.newId = getNextNodeId('T');
					nodeObj.cla = "defaultWriteNode moveLight";
					nodeObj.nodeType = 'excelWriteNode';
					nodeObj.text = "";
					nodeObj.bgColor = '#fff';
					break;
		case 'elasticWriteNode':
					nodeObj.newId = getNextNodeId('T');
					nodeObj.cla = "defaultWriteNode moveLight";
					nodeObj.nodeType = 'elasticWriteNode';
					nodeObj.text = "";
					nodeObj.bgColor = '#fff';
					break;
		case 'sftpUploadNode':
					nodeObj.newId = getNextNodeId('T');
					nodeObj.cla = "defaultWriteNode moveLight";
					nodeObj.nodeType = 'sftpUploadNode';
					nodeObj.text = "";
					nodeObj.bgColor = '#fff';
					break;
		case 'apiUploadNode':
					nodeObj.newId = getNextNodeId('T');
					nodeObj.cla = "defaultWriteNode moveLight";
					nodeObj.nodeType = 'apiUploadNode';
					nodeObj.text = "";
					nodeObj.bgColor = '#fff';
					break;
		case 'txtFileWriteNode':
					nodeObj.newId = getNextNodeId('T');
					nodeObj.cla = "defaultWriteNode moveLight";
					nodeObj.nodeType = 'txtFileWriteNode';
					nodeObj.text = "";
					nodeObj.bgColor = '#fff';
					break;
		case 'deleteTableDataNode':
					nodeObj.newId = getNextNodeId('T');
					nodeObj.cla = "defaultWriteNode moveLight";
					nodeObj.nodeType = 'deleteTableDataNode';
					nodeObj.text = "";
					nodeObj.bgColor = '#fff';
					break;
		case 'aliOSSWriteNode':
					nodeObj.newId = getNextNodeId('T');
					nodeObj.cla = "defaultWriteNode moveLight";
					nodeObj.nodeType = 'aliOSSWriteNode';
					nodeObj.text = "";
					nodeObj.bgColor = '#fff';
					break;
		case 'sgingleTableCopyNode':
					nodeObj.newId = getNextNodeId('T');
					nodeObj.cla = "defaultWriteNode moveLight";
					nodeObj.nodeType = 'sgingleTableCopyNode';
					nodeObj.text = "";
					nodeObj.bgColor = '#fff';
					break;
		case 'sgingleTableUpdateNode':
					nodeObj.newId = getNextNodeId('T');
					nodeObj.cla = "defaultWriteNode moveLight";
					nodeObj.nodeType = 'sgingleTableUpdateNode';
					nodeObj.text = "";
					nodeObj.bgColor = '#fff';
					break;
		case 'runKettleNode':
					nodeObj.newId = getNextNodeId('T');
					nodeObj.cla = "defaultWriteNode moveLight";
					nodeObj.nodeType = 'runKettleNode';
					nodeObj.text = "";
					nodeObj.bgColor = '#fff';
					break;
		case 'dataConnectorNode':
					nodeObj.newId = getNextNodeId('T');
					nodeObj.cla = "defaultNode connectorNode moveLight";
					nodeObj.nodeType = 'dataConnectorNode';
					nodeObj.text = GoalNodeName;
					nodeObj.bgColor = '#fff';
					break;
		default:
...
function showGrid() {
	if ($("#canvasId").css('background-image') == 'none') {
		...
		$("#canvasId").css('background', '#ffffff');
	}
...
function registerNodeEvent(tempId,nodeObj) {
	...
	$(selector).mouseover(function() {
		...
		if (!graph.node($(this).attr('id')).isSelected) {
			...
			// $(this).css('border', CONFIG.defaultStyle.selectedBoxBorder);
		}
	}).mouseout(function() {
		// 当节点选中标识为false，也就是未被选中时
		if (!graph.node($(this).attr('id')).isSelected) {
			$(this).css('box-shadow', NODE_NO_SELECTED_BOX_SHADOW);
			// $(this).css('border', CONFIG.defaultStyle.noSelectedBoxBorder);
		}
	...
	$(selector).mousedown(function(event) {
		...
		// $(this).css('border',"1.5px solid #f9070d");
...
function leftAlign(selectedNodeIdArr) {
	...
	for (var i = 0; i < selectedNodeIdArr.length; i++) {
		...
		let leftx=leftCount;
		if(selectedNodeIdArr[i].substring(0,1)==='E'){
			leftx+=28;
		}
		INSTANCE_JSPLUMB.animate(selectedNodeIdArr[i], {left: leftx }, { duration: CONFIG.alignParam.alignDuration } );
	}
}
...
function upAlign(selectedNodeIdArr) {
	...
	for (var i = 1; i < selectedNodeIdArr.length; i++) {
		let topx=topCount;
		// console.log(selectedNodeIdArr[i]);
		if(selectedNodeIdArr[i].substring(0,1)==='T'){
			topx=topx-2;
		}
		INSTANCE_JSPLUMB.animate(selectedNodeIdArr[i], { top: topx}, { duration: CONFIG.alignParam.alignDuration } );
	}
}
...
function SetPropertyVal(nodeId, text) {
	// console.log("SetPropertyVal=>"+nodeId+"=>"+text);
	//保存状态为未保存
	$("#saveStatus").css('display', '');
	//将当前流程对象放入可撤销数组中
	UNDO_ARR.push(getCurrentFlowDoc());

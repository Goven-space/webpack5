...
jsPlumb.ready(function() {
	...
	common = {
		 ...
		 */
		connector: [CONFIG.conn.connectionType, { curviness: 70,gap: CONFIG.conn.connectionGap, cornerRadius: CONFIG.conn.connectionCornerRadius, alwaysRespectStubs: true }],
	...
	$("#Container").droppable({
		...
		drop: function(event, ui) {
			// createNewNode(ui.draggable.context.id, ui.position);

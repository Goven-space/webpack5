import { AutoComplete, InputNumber, Button, Form, Input, Modal, Radio, Select, Spin, Tag } from 'antd';
...
import SelectServices from '../../components/GridComponents/SelectServices';
import ServiceDependencyConfig from './components/ServiceDependencyConfig';
...
class form extends React.Component{
  ...
  saveSelectedServices=(item)=>{
    if(this.state.action==='AddService'){
      //调用子窗口获取已经选中的行
			console.log(this.refs.SelectServices);

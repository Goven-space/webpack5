...
import {Table,Row, Col,Card,Menu,Icon,Tag,Dropdown,Popconfirm,Button,Modal,Badge,Divider} from 'antd';
import * as URI from '../../../core/constants/RESTURI';
import * as AjaxUtils from '../../../core/utils/AjaxUtils';
import * as GridActions from '../../../core/utils/GridUtils';
import NewMockResponseConfig from '../form/NewMockData';
import ListServicesByMockId from '../../designer/grid/ListApisByFilters';
...
class ListMockDatas extends React.Component {
  constructor(props) {
    super(props);
  ...
  render(){
    ...
    const columns=[{
      ...
      const expandedRow=(record)=>{
        return (
          <Card title="关联的API">
              <ListServicesByMockId filters={{mockResponseConfigId:[record.id]}} appId={this.props.appId}  close={this.closeModal} />
          </Card>
          );
      }

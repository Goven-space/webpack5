        ...
        if(fieldId==='nodeId'){
          ...
          if(fieldType==='number'){
            ...
            formItem=(<FormItem key={fieldId} label={fieldName} labelCol={{ span: 4 }}  wrapperCol={{ span: 16 }} >
            {
              ...
              (<DeptTreeSelect options={{dropdownStyle:{maxHeight: 400, overflow: 'auto' }}} placeholder={tip} />)
            }
            </FormItem>);
            ...
            {
              getFieldDecorator(fieldId,{rules: [{ required: required}],initialValue:defaultValue})
              (<RolesSelect options={{dropdownStyle:{maxHeight: 400, overflow: 'auto' }}} placeholder={tip} />)
            }
            </FormItem>);
          }else if(fieldType==='permission'){
            formItem=(<FormItem key={fieldId} label={fieldName} labelCol={{ span: 4 }}  wrapperCol={{ span: 16 }} >
            {
              getFieldDecorator(fieldId,{rules: [{ required: required}],initialValue:defaultValue})
              (<PermissionSelect key={fieldId} options={{dropdownStyle:{maxHeight: 400, overflow: 'auto' }}} placeholder={tip} />)
            }
            </FormItem>);
...
const NewCategoryData = Form.create()(form);

export default NewCategoryData;

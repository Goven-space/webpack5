...
const loadDataUrl=URI.Gateway_DATAMAPPING_ITEM.getById;
const saveDataUrl=URI.Gateway_DATAMAPPING_ITEM.save;
const jsontPathUrl=URI.Gateway_DATAMAPPING_ITEM.inputJsonPaths;
const treeUrl=URI.Gateway_DATAMAPPING_ITEM.tree;
          ...
          <TabPane  tab="字段值来源" key="dataFrom"  >
            <div  style={{display:(fieldType!=='array' && fieldType!=='object')?'':'none'}} >
              ...
              >{
                ...
                (<Select  >
                  <Option value={1}>API的输出或输入JSON</Option>

...
const LIST_URL=URI.Gateway_DATAMAPPING_CATEGORY.page; //分页显示
const DELETE_URL=URI.Gateway_DATAMAPPING_CATEGORY.delete;//删除
const exportConfigUrl=URI.Gateway_DATAMAPPING_CATEGORY.exportConfig;
...
class ListDataMappingCategory extends React.Component {
  constructor(props) {
    ...
    this.url=LIST_URL+"?apiId="+this.apiId;
    this.state={
  ...
  render(){
    ...
    if(this.state.action=='test'){
      title="映射测试";
      ModalWindow=<DataMappingTest data={this.state.currentRecord} apiId={this.apiId} close={this.closeModal} />
    }else{
      title="配置属性";
      ModalWindow=<NewDataMappingCategory apiId={this.apiId} appId={this.appId} id={currentId} close={this.closeModal} />
    }

...
import NewDatabaseConfig from '../form/NewDatabaseConfig';
...
class ListDatabaseConfig extends React.Component {
  constructor(props) {
    super(props);
  ...
  loadData=(pagination=this.state.pagination, filters={}, sorter={})=>{
    let url=LIST_URL;
    filters={dataType:['oracle','mysql','mssql']};
  ...
  addTabPane=(id,name,record)=>{
      ...
      let content;
      if(id==='New'){
        content=(<NewDatabaseConfig id="" appId={this.props.appId}  close={this.closeCurrentTab} />);
      }else if(id==='Edit'){
        content=(<NewDatabaseConfig id={record.id} appId={this.props.appId}  close={this.closeCurrentTab} />);
      }
    ...
    return (
      <span>
            <Tabs
              ...
              hideAdd={true}
            >
            <TabPane tab="数据库代理配置" key="home" style={{padding:'0px'}}>
              <Row style={{marginBottom:5}} gutter={0} >
                <Col span={12} >
                <ButtonGroup>
                  <Button  type="primary" onClick={this.onActionClick.bind(this,'New')} icon="plus"  >新增数据库服务</Button>
...
export default ListDatabaseConfig;
